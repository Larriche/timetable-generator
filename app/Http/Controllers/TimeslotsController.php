...
class TimeslotsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $examTimeslots = $timeslots->filter(function ($timeslot) {
            return $timeslot->type == 'EXAM';
        });

        $lectureTimeslots = $timeslots->filter(function ($timeslot) {
            return $timeslot->type == 'NORMAL';
        });

        if ($request->ajax()) {
            return view('timeslots.table', compact('examTimeslots', 'lectureTimeslots'));
        }

        return view('timeslots.index', compact('examTimeslots', 'lectureTimeslots'));
    }
