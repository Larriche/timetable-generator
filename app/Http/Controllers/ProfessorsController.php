...
class ProfessorsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $professor = $this->service->store($data);

        if ($professor) {
            return Response::json(['message' => 'Lecturer added'], 200);
        } else {
    ...
    public function show($id)
    {
        ...
        if ($professor) {
            ...
            return Response::json(['errors' => ['Lecturer not found']], 404);
        }
    }
    ...
    public function update($id, Request $request)
    {
        ...
        if (!$professor) {
            return Response::json(['errors' => ['Lecturer does not exist']], 404);
        }
        ...
        $professor = $this->service->update($id, $data);

        return Response::json(['message' => 'Lecturer updated'], 200);
    }
    ...
    public function destroy($id)
    {
        ...
        if ($this->service->delete($id)) {
            return Response::json(['message' => 'Lecturer has been deleted'], 200);
        } else {
            return Response::json(['error' => 'An unknown system error occurred'], 500);
        }
    }
